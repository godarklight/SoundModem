...
namespace SoundModem
{
    public class ITA2
    {
        ...
        public ITA2(Stream inputData)
        {
            ...
            charsDigit[' '] = chars[' '];
            chars.Add('Q', new byte[] { 1, 0, 1, 1, 1 });
            charsDigit['1'] = chars['Q'];
            chars.Add('W', new byte[] { 1, 0, 0, 1, 1 });
            charsDigit['2'] = chars['W'];
            chars.Add('E', new byte[] { 0, 0, 0, 0, 1 });
            charsDigit['3'] = chars['E'];
            chars.Add('R', new byte[] { 0, 1, 0, 1, 0 });
            charsDigit['4'] = chars['R'];
            chars.Add('T', new byte[] { 1, 0, 0, 0, 0 });
            charsDigit['5'] = chars['T'];
            chars.Add('Y', new byte[] { 1, 0, 1, 0, 1 });
            charsDigit['6'] = chars['Y'];
            chars.Add('U', new byte[] { 0, 0, 1, 1, 1 });
            charsDigit['7'] = chars['U'];
            chars.Add('I', new byte[] { 0, 0, 1, 1, 0 });
            charsDigit['8'] = chars['I'];
            chars.Add('O', new byte[] { 1, 1, 0, 0, 0 });
            charsDigit['9'] = chars['O'];
            chars.Add('P', new byte[] { 1, 0, 1, 1, 0 });
            charsDigit['0'] = chars['P'];
            chars.Add('A', new byte[] { 0, 0, 0, 1, 1 });
            charsDigit['-'] = chars['A'];
            chars.Add('S', new byte[] { 0, 0, 1, 0, 1 });
            charsDigit[(char)7] = chars['S'];
            chars.Add('D', new byte[] { 0, 1, 0, 0, 1 });
            charsDigit['$'] = chars['D'];
            chars.Add('F', new byte[] { 0, 1, 1, 0, 1 });
            charsDigit['!'] = chars['F'];
            chars.Add('G', new byte[] { 1, 1, 0, 1, 0 });
            charsDigit['&'] = chars['G'];
            chars.Add('H', new byte[] { 1, 0, 1, 0, 0 });
            charsDigit['#'] = chars['H'];
            chars.Add('J', new byte[] { 0, 1, 0, 1, 1 });
            charsDigit['\''] = chars['J'];
            chars.Add('K', new byte[] { 0, 1, 1, 1, 1 });
            charsDigit['('] = chars['K'];
            chars.Add('L', new byte[] { 1, 0, 0, 1, 0 });
            charsDigit[')'] = chars['L'];
            chars.Add('Z', new byte[] { 1, 0, 0, 0, 1 });
            charsDigit['"'] = chars['Z'];
            chars.Add('X', new byte[] { 1, 1, 1, 0, 1 });
            charsDigit['/'] = chars['X'];
            chars.Add('C', new byte[] { 0, 1, 1, 1, 0 });
            charsDigit[':'] = chars['C'];
            chars.Add('V', new byte[] { 1, 1, 1, 1, 0 });
            charsDigit[';'] = chars['V'];
            chars.Add('B', new byte[] { 1, 1, 0, 0, 1 });
            charsDigit['?'] = chars['B'];
            chars.Add('N', new byte[] { 0, 1, 1, 0, 0 });
            charsDigit[','] = chars['N'];
            chars.Add('M', new byte[] { 1, 1, 1, 0, 0 });
            charsDigit['.'] = chars['M'];
            chars.Add((char)10, new byte[] { 0, 1, 0, 0, 0 });
            chars.Add((char)13, new byte[] { 0, 0, 0, 1, 0 });
        }
